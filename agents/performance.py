...
class PerformanceAgent:
    ...
    def analyze_directory(
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=3) as executor:
            future_to_file = {
                executor.submit(self._analyze_file, file_info['path'], complexity_issues, maintainability_issues): file_info
...
"""
    ...
    def _get_llm_response(self, messages: List) -> str:
        ...
        try:
            ...
            short_msg = error_msg.split('\n')[0][:200]
            logger.warning(f"⚠️ Primary LLM failed in Performance Agent, falling back to Ollama: {short_msg}")
